...
const openMyWeatherApp = document.getElementById('openMyWeatherApp');


openMyWeatherApp.addEventListener('click', function() {

    const websiteUrl = 'https://clintwebdev.github.io/WeatherApp/';
